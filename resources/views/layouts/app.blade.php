...
<body x-data="{ panelOpen: true }"
class="bg-slate-50 text-slate-800 h-screen flex overflow-hidden antialiased">
    @include('layouts.sidebar')

    <main class="flex-1 flex flex-col h-screen overflow-hidden relative transition-all duration-300">
    ...
    <button
        ...
        <svg x-show="panelOpen" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M15 19l-7-7 7-7"/>
        </svg>
...
x-show="panelOpen"
x-transition
class="w-80 bg-white border-l border-slate-200 hidden xl:flex flex-col shrink-0 z-20 h-screen">   
