    ...
    <div>
        ...
        <nav class="p-4 space-y-1.5 mt-2 overflow-y-auto">
            ...
            @if(Auth::check() && Auth::user()->jabatan === 'admin')
                ...
                <a href="{{ route('logs.index') }}" class="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:bg-slate-50 hover:text-blue-600 rounded-xl text-sm font-medium transition-colors border border-transparent">
